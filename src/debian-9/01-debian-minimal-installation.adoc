...
= _Debian_ 9 basic installation with _Gnome_
☣ By Alejandro Martin

include::{include-dir}/version.adoc[]

* Used release is _Debian 9 - Stretch_
...
+
TIP: For more detailed info about this step, you can follow this https://linuxhint.com/debian_9_minimal_install/[guide, window="_blank"].
...
+
For support on _GeForce_ 6xxx and 7xxx GPUs:
+
...
IMPORTANT: After installation you should verify that the _Debian_ partition is the primary boot
drive for your device in order to run the grub for multi-booting systems.
