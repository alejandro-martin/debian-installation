...
+
. [Optional step] if you keep stable version and you want newer packages
(from testing distribution, mostly) you could add the _backports_ repositories.
+
...
# backports
deb-src http://ftp.mx.debian.org/debian/ stretch-backports main contrib non-free
----
+
